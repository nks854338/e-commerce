        ...
        <div class="navbar">
            ...
            <div class="navComponentBox">
                ...
                if (isset($_SESSION['user'])) {
                    ...
                    echo '<div class="user"><a href="user/logout.php"><div class="userProfileBox"><div class="userProfileIcon"><i class="fa-regular fa-user"></i></div><div class="userProfileTitle">Profile</div></div></a></div>';
